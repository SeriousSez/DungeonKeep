...
public interface IAuthService
{
    ...
    Task<PasswordResetRequestAcceptedDto> RequestPasswordResetAsync(RequestPasswordResetRequest request, string? clientBaseUrl, CancellationToken cancellationToken = default);
    Task<PasswordResetResultDto> CompletePasswordResetAsync(CompletePasswordResetRequest request, CancellationToken cancellationToken = default);
