...
const baseEquipmentCatalog: ReadonlyArray<EquipmentItem> = [
    ...
    { name: 'Battleaxe', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 4, costGp: 10, notes: 'Martial, Versatile (1d10), Topple' },
    { name: 'Flail', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 2, costGp: 10, notes: 'Martial, Sap' },
    { name: 'Glaive', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 6, costGp: 20, notes: 'Martial, Heavy, Reach, Two-Handed, Graze' },
    { name: 'Greataxe', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 7, costGp: 30, notes: 'Martial, Heavy, Two-Handed, Cleave' },
    ...
    { name: 'Halberd', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 6, costGp: 20, notes: 'Martial, Heavy, Reach, Two-Handed, Cleave' },
    { name: 'Lance', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 6, costGp: 10, notes: 'Martial, Reach, Special, Topple' },
    { name: 'Longsword', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 3, costGp: 15, notes: 'Martial, Versatile (1d10), Sap' },
    { name: 'Maul', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 10, costGp: 10, notes: 'Martial, Heavy, Two-Handed, Topple' },
    { name: 'Morningstar', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 4, costGp: 15, notes: 'Martial, Sap' },
    { name: 'Pike', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 18, costGp: 5, notes: 'Martial, Heavy, Reach, Two-Handed, Push' },
    ...
    { name: 'Shortsword', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 2, costGp: 10, notes: 'Martial, Finesse, Light, Vex' },
    { name: 'Trident', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 4, costGp: 5, notes: 'Martial, Thrown, Versatile (1d8), Topple, Range (20/60)' },
    { name: 'War Pick', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 2, costGp: 5, notes: 'Martial, Sap' },
    { name: 'Warhammer', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 2, costGp: 15, notes: 'Martial, Versatile (1d10), Push' },
    { name: 'Whip', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', weight: 3, costGp: 2, notes: 'Martial, Finesse, Reach, Slow' },
    // Setting-Specific Weapons
    { name: 'Yklwa', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', sourceLabel: 'ToA', weight: 3, costGp: 1, notes: 'Simple, Thrown, Range (10/30)' },
    { name: 'Hoopak', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', sourceLabel: 'D:SDQ', weight: 2, costGp: 1, notes: 'Martial, Ammunition, Finesse, Special, Two-Handed, Range (40/160)' },
    { name: 'Double-Bladed Scimitar', category: 'Weapon', sourceUrl: 'https://dnd5e.wikidot.com/weapons', sourceLabel: 'ERftLW', weight: 6, costGp: 100, notes: 'Martial, Special, Two-Handed' },
    // Armor
    ...
    { name: 'Hide Armor', category: 'Armor', sourceUrl: 'https://dnd5e.wikidot.com/armor', weight: 12, costGp: 10, notes: 'Medium Armor, AC 12+Dex (max 2)' },
    ...
    { name: 'Ring Mail', category: 'Armor', sourceUrl: 'https://dnd5e.wikidot.com/armor', weight: 40, costGp: 30, notes: 'Heavy Armor, AC 14, Stealth Disadvantage' },
    ...
    // Firearms (DMG optional)
    { name: 'Pistol', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 3, costGp: 250, notes: 'Renaissance, Martial, Ammunition, Loading, Range (30/90)' },
    { name: 'Musket', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 10, costGp: 500, notes: 'Renaissance, Martial, Ammunition, Loading, Two-Handed, Range (40/120)' },
    { name: 'Automatic Pistol', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 3, notes: 'Modern, Martial, Ammunition, Reload (15 shots), Range (50/150)' },
    { name: 'Revolver', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 3, notes: 'Modern, Martial, Ammunition, Reload (6 shots), Range (40/120)' },
    { name: 'Hunting Rifle', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 8, notes: 'Modern, Martial, Ammunition, Reload (5 shots), Two-Handed, Range (80/240)' },
    { name: 'Automatic Rifle', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 8, notes: 'Modern, Martial, Ammunition, Burst Fire, Reload (30 shots), Two-Handed, Range (80/240)' },
    { name: 'Shotgun', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 7, notes: 'Modern, Martial, Ammunition, Reload (2 shots), Two-Handed, Range (30/90)' },
    { name: 'Laser Pistol', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 2, notes: 'Futuristic, Martial, Ammunition, Reload (50 shots), Range (40/120)' },
    { name: 'Laser Rifle', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 7, notes: 'Futuristic, Martial, Ammunition, Reload (30 shots), Two-Handed, Range (100/300)' },
    { name: 'Antimatter Rifle', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', sourceLabel: 'DMG', weight: 10, notes: 'Futuristic, Martial, Ammunition, Reload (2 shots), Two-Handed, Range (120/360)' },
    { name: 'Pepperbox', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', weight: 5, costGp: 250, notes: 'Homebrew/CR style, Martial, Ammunition, Reload (6 shots), Range (30/90)' },
    { name: 'Blunderbuss', category: 'Firearm', sourceUrl: 'https://dnd5e.wikidot.com/firearms', weight: 10, costGp: 300, notes: 'Homebrew/CR style, Martial, Ammunition, Loading, Two-Handed, Range (15/30)' },
